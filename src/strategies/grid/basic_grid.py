...
class BasicGridStrategy(TradingStrategy):
    ...
    def _initialize_grid(self, current_price: float, balance: float) -> List[TradingSignal]:
        ...
        for level in self.grid_levels:
            if level.is_buy_level and level.price < current_price:
                ...
                signals.append(TradingSignal(
                    ...
                    metadata={"level_index": level.level_index, "grid_type": "initial"}
                ))
    ...
    def _rebalance_grid(self, current_price: float, balance: float) -> List[TradingSignal]:
    ...
    def on_trade_executed(self, signal: TradingSignal, executed_price: float, executed_size: float) -> None:
