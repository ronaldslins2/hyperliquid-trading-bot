...
class GridTradingBot:
    ...
    def _convert_config(self) -> dict:
        ...
        total_allocation_usd = base_allocation_usd * (self.config.account.max_allocation_pct / 100.0)
        ...
        return {
            ...
            "bot_config": {
                ...
                "testnet_private_key": getattr(self.config, 'testnet_private_key', None),
                "mainnet_private_key": getattr(self.config, 'mainnet_private_key', None),
            },
...
async def main():
    ...
    parser.add_argument("config", nargs='?', help="Configuration file path (optional - will auto-discover if not provided)")
